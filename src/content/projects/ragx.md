...
stack: TypeScript · Next.js 15 / React 19 · Postgres + pgvector · Vercel
metric: 0.97 retrieval · 0.98 answer accuracy
metricNote: on a 45-case eval it scores itself — deployed and live.
demoUrl: https://ragx-rosy.vercel.app/
...
- **Deployed and public** on Vercel + Neon: ~10k chunks across four real
  filings (Berkshire Hathaway, JPMorgan, Microsoft, Costco).

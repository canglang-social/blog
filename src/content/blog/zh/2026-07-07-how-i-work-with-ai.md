...
![2026-07-07 当天的完整系统地图：十二个工作流按所属仓库分组，它们之间的连线，以及包住一切的审计边界——每个节点都是 inventory.yaml 里的一行。](../../../assets/how-i-work-with-ai/atlas-system-map.svg)

*这是本文发布当天的地图快照；最新版本见持续从清单重建的 [System Atlas](/zh/atlas/)。*

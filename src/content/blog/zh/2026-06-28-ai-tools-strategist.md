---
title: 'AI 工具策略师'
description: '做一个告诉我该用哪个 AI 工具的工具——以及一个普通人为什么需要它。'
pubDate: 'Jun 28 2026'
...
4. **撰写简历（Crafting a Resume）** —— Claude 对话，导入到 Claude Project。
...
5. **简历评审（Resume Review）** —— Claude 对话，导入到 Claude Project。
